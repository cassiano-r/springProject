...
@Configuration
@ComponentScan(basePackages = {"br.com.cassiano.springproject.entity",
		"br.com.cassiano.springproject.dao",
		"br.com.cassiano.springproject.service"})
public class TestJPAContextConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean()
	{
		...
		lcef.setPackagesToScan(new String [] {"br.com.cassiano.springproject.entity"});
