package br.com.cassiano.springproject.controller;
...
import br.com.cassiano.springproject.controllers.UserController;
...
public class UserControllerTest {
	...
	public void shouldSaveUser() throws Exception{
		...
		mockMvc.perform(MockMvcRequestBuilders.post(ENDPOINT).content(toJson(user))).andExpect(MockMvcResultMatchers.status().isOk());
	}
